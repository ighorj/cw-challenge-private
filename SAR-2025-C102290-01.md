...
| **Subject Name** | [Redacted — see KYC record] |
...
| Alert | Detection Logic | Key Event / Date | Relevance |
|---|---|---|---|
| **PEP-EDD-001** | Customer flagged PEP=Yes; mandatory EDD trigger | KYC record (ongoing) | Mandatory EDD per FATF Rec. 12 / Circular BACEN 3.978 |
| **VEL-BURST-002** | ≥4 transactions in single calendar day | 2025-08-01 — 4 txs, R$42,590 | Daily burst inconsistent with declared income |
| **PASSTHRU-003** | (Outflow ÷ Inflow) > 200% on platform | Review period total: 2,013% | Funds likely originate outside monitored platform |
| **ANON-IP-004** | Use of Tor / VPN / Proxy | 2× VPN events; 1× Tor-routed transaction | Network anonymization inconsistent with low-risk customer profile |
| **INCOME-MISMATCH-005** | Outflow > 50× declared monthly income | R$134k vs R$931/month (≈ 144×) | Material disparity vs declared profile |
| **GEO-RISK-006** | Cross-border geo to monitored jurisdiction | 1× geo-tagged transaction to AE | Low individual weight; relevant in aggregate |
| **KYC-INCONSISTENCY-011** | PEP=Yes and/or KYC Risk Score ≥80 combined with categorical risk_rating < High or tier = L1 | KYC profile contains contradictory risk classifications (PEP=Yes, Score=98, yet Rating=Medium, Tier=L1) | Internal KYC control gap; requires governance review |
...
| **2025-08-01** | **Velocity burst** | 4 PIX transactions in single day totalling **R$42,590.11**, including R$20,509 + R$11,742 high-value pair within ~18-hour window |
| **2025-08-12** | Wire + first anonymization | Wire to M200662 (R$1,364) — cross-rail activity initiated; transaction routed via VPN |
| **2025-09-28** | VPN-routed PIX | PIX to M200393 (R$8,506) routed via VPN |
| **2025-09 (period)** | UAE geo-tag | Single cross-border geo to AE |
| **2025-10-03** | Tor-routed Card | Card transaction to M200122 (R$3,835, MCC 6011 — ATM/cash) routed via Tor — escalation to higher-grade anonymization |
