...
|---|---|---|---|---|
| **R01-VEL-BURST** | ≥4 transactions in single calendar day | 2025-08-01 · 04:19 – 21:49 (4 txs, R$42,590) | **TJQAMN5JTWDXB**, **TVK4KFT22QPUH** (2 highest-value of 4) | Daily burst inconsistent with declared income |
| **R03-INCOME-MISMATCH** | Outflow > 50× declared monthly income | Review period aggregate (R$134k vs R$931/mo ≈ 144×) | — (aggregate metric) | Material disparity vs declared profile |
| **R04-PASSTHRU** | (Outflow ÷ Inflow) > 200% on platform | Review period 2025-07-01 → 2025-10-31; ratio 2,013% | — (aggregate metric) | Funds likely originate outside monitored platform |
| **R05-ANON-TOR / VPN** | Use of Tor / VPN / Proxy on financial transactions | 2025-08-12 02:50 (VPN, Wire); 2025-09-28 21:35 (VPN, PIX); 2025-10-03 20:03 (Tor, Card) | **TB24ZK5RW3PP8**, **TZ76800M19NE3**, **TNUU7IUG3D1A2** | Network anonymization inconsistent with low-risk customer profile |
| **R09-PEP-EDD** | Customer flagged PEP=Yes; mandatory EDD trigger | KYC record (ongoing) | — (customer-level) | Mandatory EDD per FATF Rec. 12 / Circular BACEN 3.978 |
| **R10-KYC-INCONSIST** | PEP=Yes and/or KYC Risk Score ≥80 combined with risk_rating < High or tier = L1 | KYC profile (ongoing); PEP=Yes, Score=98, Rating=Medium, Tier=L1 | — (KYC-level) | Internal KYC control gap; requires governance review |
| **R11-MCC-HIGH-RISK** | ≥3 transactions to high-risk MCC merchants (6011, 6051, 6211, 4111) | Review period aggregate | — (aggregate metric) | Repeated use of high-risk merchant categories consistent with layering typology |
| **R15-FAN-OUT** | ≥25 distinct receiving counterparties in review period | Review period aggregate; 27 distinct counterparties | — (aggregate metric) | Wide dispersion consistent with distribution-stage layering |
| **R17-MULTI-RAIL** | Mixed-rail activity: PIX + Card + Wire within review window | PIX (16 txs), Card (10 txs), Wire (1 tx) | — (aggregate metric) | Multi-rail channel diversification consistent with layering typology indicators |
| **R19-CHARGEBACK** | Repeat use of merchants with elevated chargeback ratio (≥10%) | Review period aggregate | — (aggregate metric) | Repeated exposure to high-chargeback merchants; counterparty risk indicator |
| **R20-MERCHANT-CONVERGE** | Shared receiving merchant with independently flagged subject | Review period; M200460, M200186 shared with C100880 | — (aggregate metric) | Structural convergence point between independently flagged subjects; network linkage indicator |
...
<img src="../../outputs/figures/C102290_income_vs_outflow.png" width="650">
...
6. **Linked Case Coordination** — Cross-reference findings with parallel reviews on C100880 (shared merchants M200460/M200186) and other top-10 cohort subjects (C100091, C102093, C100208) to ensure consistent case management across the flagged network.
